...
if (document.getElementById('BOOT_CONF_TEX') == null) {
  ...
  tex.rows = 5;
  tex.style = 'position:fixed;bottom:40px;z-index:9;height:' + boot_text_height + ';width:100%;font-size:12px;'
...
function BOOT_CFG_EXPAND_TOGGLE() {
  ...
  if (expand.style.height == cfg_text_height) {
    ...
    document.getElementById('BOOT_CONF_EXPAND').textContent = 'Cfg縮小';
  } else {
    expand.style.height = cfg_text_height;
    document.getElementById('BOOT_CONF_EXPAND').textContent = 'Cfg拡張';
  }
}
